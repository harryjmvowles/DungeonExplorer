    ...
    public class RoomManager
    {
        ...
        public RoomManager()
        {
            ...
            predefinedRooms.Add("The Lost Hall", new Room(
                ...
                {
                { "North", new Door("The Lost Hall to The Forgotten Chamber", true) }, // Locked door
                { "East", new Door("The Lost Hall to The Silent Corridor", false) } // Unlocked door
                }
            ));
            ...
            predefinedRooms.Add("The Forgotten Chamber", new Room(
                ...
                new Dictionary<string, Door>
                {
                { "West", new Door("The Forgotten Chamber to The Lost Hall", true) }, // Locked door
                { "South", new Door("The Forgotten Chamber to The Grand Hall", false) } // Unlocked door
                }
            ));
            ...
            predefinedRooms.Add("The Silent Corridor", new Room(
                ...
                new Dictionary<string, Door>
                {
                { "North", new Door("The Silent Corridor to The Dark Vault", true) }, // Locked door
                { "East", new Door("The Silent Corridor to The Abandoned Workshop", false) } // Unlocked door
                }
            ));
            ...
            predefinedRooms.Add("The Grand Hall", new Room(
                ...
                new Dictionary<string, Door>
                {
                { "West", new Door("The Grand Hall to The Forgotten Chamber", false) }, // Unlocked door
                { "South", new Door("The Grand Hall to The Wretched Tomb", true) } // Locked door
                }
            ));
            ...
            predefinedRooms.Add("The Dark Vault", new Room(
                ...
                new Dictionary<string, Door>
                {
                { "North", new Door("The Dark Vault to The Forgotten Passage", true) }, // Locked door
                { "East", new Door("The Dark Vault to The Escape Room", false) } // Unlocked door
                }
            ));
            ...
            predefinedRooms.Add("The Abandoned Workshop", new Room(
                ...
                new Dictionary<string, Door>
                {
                { "West", new Door("The Abandoned Workshop to The Silent Corridor", false) }, // Unlocked door
                { "South", new Door("The Abandoned Workshop to The Forgotten Passage", true) } // Locked door
                }
            ));
            ...
            predefinedRooms.Add("The Wretched Tomb", new Room(
                ...
                new Dictionary<string, Door>
                {
                { "North", new Door("The Wretched Tomb to The Grand Hall", true) } // Locked door
                }
            ));
            ...
            predefinedRooms.Add("The Escape Room", new Room(
                ...
                new Dictionary<string, Door>
                {
                { "West", new Door("The Escape Room to The Dark Vault", false) } // Unlocked door
                }
            ));
            ...
            predefinedRooms.Add("The Forgotten Passage", new Room(
                ...
                new Dictionary<string, Door>
                {
                { "South", new Door("The Forgotten Passage to The Abandoned Workshop", true) } // Locked door
                }
            ));
